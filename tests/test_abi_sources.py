...
class TestSolidityTypeToGraph:
    ...
    def test_address_to_address(self):
        assert solidity_type_to_graph("address") == "Address"
...
class TestExtractEvents:
    ...
    def test_extracts_event_params(self):
        ...
        assert params[0]["graph_type"] == "Address"
    ...
    def test_builds_event_signature(self):
        ...
        assert events[0]["signature"] == "Transfer(indexed address,indexed address,uint256)"

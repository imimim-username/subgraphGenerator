...
def render_ponder_npmrc() -> str:
    """Return a .npmrc for generated Ponder projects (pnpm).

    Enforces exact version pinning so that any package the user adds after
    generation is pinned as "1.2.3" rather than "^1.2.3".
    """
    return (
        "# Enforce exact version pins — supply-chain hardening.\n"
